...
class AttnLabelDecode(BaseRecLabelDecode):
    ...
    def get_beg_end_flag_idx(self, beg_or_end):
        if beg_or_end == "beg":
            ...
            raise AssertionError("unsupport type %s in get_beg_end_flag_idx" % beg_or_end)
        return idx
    ...
    def get_beg_end_flag_idx(self, beg_or_end, char_or_elem):
        if char_or_elem == "char":
            if beg_or_end == "beg":
                ...
                raise AssertionError("Unsupport type %s in get_beg_end_flag_idx of char" % beg_or_end)
            ...
            if beg_or_end == "beg":
                ...
                raise AssertionError("Unsupport type %s in get_beg_end_flag_idx of elem" % beg_or_end)
        else:
            raise AssertionError("Unsupport type %s in char_or_elem" % char_or_elem)
        return idx
